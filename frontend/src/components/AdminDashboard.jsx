...
const AdminDashboard = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className={`flex items-center space-x-1 px-2 sm:px-3 py-1 rounded transition-colors ${
                  isScrolled
      ...
      <div className="pt-20">
        {/* Navigation Tabs */}
        <div className="bg-white border-b overflow-x-auto sticky top-20 z-[90]">
          <nav className="flex min-w-max">
            <button
              className={`px-4 sm:px-6 py-4 font-medium flex items-center space-x-2 ${
                activeTab === "pending"
              ...
              <div className="p-2 sm:p-4">
                ...
                <div className="aspect-w-16 aspect-h-9 bg-gray-900 rounded overflow-hidden mb-4">
                  {selectedVideo?.link ? (
                    ...
                    <div className="flex items-center justify-center h-48 sm:h-72 bg-gray-800 text-white">
                      No video available
                    </div>
                  )}
                </div>
        ...
        {/* Main Content */}
        <main className="p-2 sm:p-6 relative z-0">
          {/* Pending Videos */}
          {activeTab === "pending" && (
            <div>
          ...
          {activeTab === "analytics" && (
            <div>
              <h2 className="text-lg sm:text-xl font-bold mb-6">Platform Analytics</h2>
          ...
          {activeTab === "reports" && (
            <div>
              <h2 className="text-lg sm:text-xl font-bold mb-6">Manage Reports</h2>
